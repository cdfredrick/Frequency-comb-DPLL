...
//integrate_and_dump # (
//  .N_BITS_CYCLES_COUNTER(7),
//  .N_DATA_BITS(10)
//
//)
//integrate_and_dump_adc0 (
//    .rst(rst_frontend0), 
//    .clk(clk1), 
//    .data_in(inst_frequency0), 
//    .data_output(inst_frequency0_filtered_for_fll), 
//    .output_clk_enable()
//    );
//
//
...
//  .ADDRESS(16'h7000)
//)
//parallel_bus_register_fll0_settings (
//    .clk(clk1), 
//    .bus_strobe(cmd_trig), 
//    .bus_address(cmd_addr), 
//    .bus_data({cmd_data2in, cmd_data1in}), 
//    .register_output({fll0_lock, fll0_gain_left_shift_in_bits, fll0_gain_right_shift_in_bits}), 
//    .update_flag()
//    );
//   
//// Finally the FLL itself:
//reg [15:0] fll0_output;
//
//acquisition_FLL # (
//  .FREQUENCY_WIDTH(10+7),
//  .OUTPUT_WIDTH(16)
//)
//acquisition_FLL0 (
//    .rst(rst_frontend0), 
//    .clk(clk1), 
//    .lock(fll0_lock), 
//    .frequency_input(inst_frequency0_filtered_for_fll), 
//    .gain_right_shift_in_bits(fll0_gain_right_shift_in_bits), 
//    .gain_left_shift_in_bits(fll0_gain_left_shift_in_bits), 
...
//assign modulation_output_to_dac2 = vna_output_to_dac2;
