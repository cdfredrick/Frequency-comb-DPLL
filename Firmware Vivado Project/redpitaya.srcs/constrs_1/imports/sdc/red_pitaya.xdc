...
# ADC Clock Duty Cycle Stabilizer (CDCS) Output
set_property IOSTANDARD LVCMOS18 [get_ports adc_cdcs_o]
set_property PACKAGE_PIN V18 [get_ports adc_cdcs_o]

# Optional ADC Input Encoder Clock Output
#set_property IOSTANDARD DIFF_HSTL_II_18 [get_ports {adc_clk_o[*]}]
