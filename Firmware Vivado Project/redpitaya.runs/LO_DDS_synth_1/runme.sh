...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/LO_DDS_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LO_DDS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LO_DDS.tcl
