...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/system_identification_outputgain_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_identification_outputgain_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_identification_outputgain_mult.tcl
