...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/fir_compiler_minimumphase_N_times_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_minimumphase_N_times_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_minimumphase_N_times_clk.tcl
