...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/pll_wide_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_wide_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_wide_mult.tcl
