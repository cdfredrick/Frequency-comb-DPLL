...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/input_multiplier_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_multiplier.tcl
