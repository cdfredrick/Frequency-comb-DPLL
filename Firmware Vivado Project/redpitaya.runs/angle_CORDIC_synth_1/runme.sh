...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/angle_CORDIC_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log angle_CORDIC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source angle_CORDIC.tcl
