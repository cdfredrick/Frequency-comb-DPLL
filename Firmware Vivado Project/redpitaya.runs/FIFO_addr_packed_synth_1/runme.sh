...
HD_PWD='C:/Git/Frequency-comb-DPLL/Firmware Vivado Project/redpitaya.runs/FIFO_addr_packed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_addr_packed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_addr_packed.tcl
